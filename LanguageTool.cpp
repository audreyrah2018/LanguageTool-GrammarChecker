//Project reading/writing to a file and writing the functions inorder to help user to get the correct grammer points like Le complément d'objet indirect et direct
...
while (exit!=0)    // help user end the program or not
{
	...
	ifstream myfile1 ("a.txt", ios::in) ; // for reading from the file, if stream for input file stream class 
